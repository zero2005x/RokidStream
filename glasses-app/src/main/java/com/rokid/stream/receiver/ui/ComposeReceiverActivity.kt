...
/**
 * Compose-based Activity for RokidStream Receiver App (Glasses)
 * 
 * This activity uses Jetpack Compose for UI while maintaining
 * the existing video streaming logic.
 */
abstract class ComposeReceiverActivity : ComponentActivity() {
    
    protected val viewModel: ReceiverViewModel by viewModels()
    
    // Camera preview view reference (glasses camera)
        ...
        setContent {
            RokidStreamTheme {
                ...
                ReceiverScreen(
                    ...
                    onStartServerClick = { onStartServerClicked() },
                    onStopServerClick = { onStopServerClicked() },
                    onSettingsClick = {
    ...
    /**
     * Called when start server button is clicked
     */
    protected abstract fun onStartServerClicked()
    
    /**
     * Called when stop server button is clicked
     */
    protected abstract fun onStopServerClicked()
