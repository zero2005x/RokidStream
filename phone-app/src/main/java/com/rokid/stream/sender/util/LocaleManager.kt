...
object LocaleManager {
    ...
    /**
     * Get byte code for BLE transmission.
     * Returns the enum ordinal as byte.
     */
    fun getLanguageByteCode(context: Context): Byte {
        val language = getSavedAppLanguage(context)
        return language.ordinal.toByte()
    }
